...
<section class="bg-light1 pt-5 pb-5">
    <div class="container">
        <form action="/employee/search">
            ...
            <div class="row justify-content-center pt-3">
                            <div class="col-3 col-sm-3 col-md-2 col-lg-2 text-end">
                                <label for="departmentNameSearch" class="form-label m-0 pt-1">Department Name</label>
                            </div>
                            <div class="col-8 col-sm-9 col-md-6 col-lg-4">
                                <input type="text" class="form-control" id="departmentNameSearch" name="departmentNameSearch" placeholder="Search by last name" value="${departmentNameSearch}"/>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <h3 class="text-center pb-3">Customers Found ${employeeVar.size()}</h3>
